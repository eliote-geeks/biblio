...
<head>
    ...
    <meta name="description"
        content="Books Merge is a fully responsive and yet modern premium bootstrap 5 template & snippets. Geek is feature-rich components and beautifully designed pages that help you create the best possible website and web application projects. Bootstrap Snippet " />
    <meta name="keywords"
        content="Books Merge UI, bootstrap, bootstrap 5, Course, Sass, landing, Marketing, admin themes, bootstrap admin, bootstrap dashboard, ui kit, web app, multipurpose" />
    ...
    <title>Books-Merge - Library</title>
</head>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-default">
        <div class="container-fluid px-0">
            ...
            <a class="navbar-brand" href="/"><span class="fw-bold fs-2">Book Merge</span></a>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-arrow" aria-labelledby="navbarBrowse">
                            @foreach (\App\Models\Category::all() as $cat)
                                <li>
                                    <a href="{{ route('category.show', $cat) }}" class="dropdown-item">
                                        {{ $cat->name }}
                                    </a>
                                </li>
                            @endforeach
                    ...
                    <li class="dropdown ms-2 d-inline-block">
                        <a class="rounded-circle" href="#" data-bs-toggle="dropdown" data-bs-display="static"
                            ...
                            <div class="avatar avatar-md avatar-indicators avatar-online">
                                <img alt="avatar" @auth
src="{{ Auth::user()->profile_photo_url }}" @endauth
                                    @guest src="assets/images/brand/logo/logo.svg" @endguest class="rounded-circle" />
                            </div>
                        </a>
                        @auth
        ...
        <div class="container">
            <div class="row align-items-center g-0 border-top py-2">
                ...
                <div class="col-md-6 col-12 text-center text-md-start">
                    <span>© {{ date('Y') }} Book Merge. All Rights Reserved.</span>
                </div>
                <!-- Links -->
